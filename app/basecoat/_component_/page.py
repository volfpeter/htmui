...
basecoat_components: dict[str, ComponentData] = {
    ...
    "input-group": {
        "title": "Input Group",
        "code_example": input_group_example,
        "component_impl": input_group,
        "example": None,
    },
    "item": {
        "title": "Item",
    ...
    "slider": {
        "title": "Slider",
        "code_example": slider_example,
        "component_impl": slider,
        "example": None,
    },
    "spinner": {
        "title": "Spinner",
    ...
    "switch": {
        "title": "Switch",
        "code_example": switch_example,
        "component_impl": switch,
        "example": None,
    },
    "table": {
        "title": "Table",
